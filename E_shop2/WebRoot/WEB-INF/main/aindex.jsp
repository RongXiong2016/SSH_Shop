...
<body class="easyui-layout"> 
 <div id="win" data-options="collapsible:false,minimizable:false,maximizable:false,modal:true"></div> 
        <div data-options="region:'north',title:'欢迎来到后台管理',split:true" style="height:100px;background:#66CC99;"></div>     
        <div data-options="region:'west',title:'系统操作',split:true" style="width:200px;">  
            <!-- 此处显示的是系统菜单 -->  
            <div id="menu" class="easyui-accordion" style="width:150px;height:200px;">     
        ...
        <div data-options="region:'center',title:'后台操作页面'" style="padding:1px;background:#eee;">
       		 <div id="tt" class="easyui-tabs" data-options="fit:true">
        			<div title="后台缺省页面" style="padding: 10px;">
        			此处以后显示相应的系统信息
        			</div>
       		 </div>
        </div>     
